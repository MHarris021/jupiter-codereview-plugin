...
/**
 * Provides the listener to listen the part change for
 * <code>ReviewEditorView</code>.
 * 
 * @author Takuya Yamashita
 * @version $Id: ReviewEditorViewPartListenerAdapter.java 40 2007-05-30
 *          00:24:50Z hongbing $
 */
class ReviewEditorViewPartListenerAdapter implements IPartListener {
	...
	public void partDeactivated(IWorkbenchPart part) {
		if (part instanceof ReviewEditorView) {
			...
			reviewEditorActionContainer.getSaveAction().run();
		}
	}
